...
- **Plex Stream Detection** — Automatically detects active streaming sessions on Plex and pauses background poller queries and missing requests recovery checks while anyone is watching. This eliminates background API traffic to debrid providers during streaming, preventing rate-limiting and stream freezing.

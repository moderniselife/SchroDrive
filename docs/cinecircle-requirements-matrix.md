...
| B. Seerr → Radarr/Sonarr request flow | Fixture/Arr boundary validated; compose import still pending | [E2E plan](cinecircle-three-input-e2e-plan.md); `tests/e2e/arr-bridge/`; [operational validation](cinecircle-operational-validation-2026-09-18.md) | Full isolated Seerr → Arr → import → library E2E still required |
...
| Torrentio added to existing Prowlarr from Riven settings | Installed and real film/episode probes PASS; test Arr sync PASS | [Cardigann proposal](cinecircle-torrentio-cardigann-proposal-2026-09-18.md); [Prowlarr readback](cinecircle-prowlarr-torrentio-readback-2026-09-18.md); [operational validation](cinecircle-operational-validation-2026-09-18.md) | Keep Mircrew/indexers unchanged; monitor provider contract and approve any future live config change |
...
| Reproducible isolated test stack | Available; webhook wiring and 105-test suite PASS | [E2E plan](cinecircle-three-input-e2e-plan.md); `/home/samtruman/docker/cinecircle-test/compose.yml`; [operational validation](cinecircle-operational-validation-2026-09-18.md) | Full provider-backed import remains intentionally unexecuted |

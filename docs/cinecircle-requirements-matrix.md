...
| Provider reconciliation capability negotiation | Generic capability seam implemented / matrix-tested; AllDebrid is the first concrete provider | `src/services/providerReconciliationCapabilities.ts`; `tests/unit/services/provider-reconciliation-capabilities.test.ts`; [PR assessment](cinecircle-pr-assessment-2026-09-17.md) | Upstream review of capability declarations and provider-specific fallback policy |

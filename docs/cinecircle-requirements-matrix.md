...
| C. In-process AllDebrid reconciliation → SchröDrive → Arr | Fork scope; DavDebrid removed from final design | [DavDebrid assessment](cinecircle-davdebrid-integration-assessment-2026-09-17.md); [architecture](cinecircle-pipeline-architecture-2026-09-17.md); [E2E plan](cinecircle-three-input-e2e-plan.md); `src/services/cinecircleAlldebridIntake.ts` | Recent/full reconciliation wiring, changed detection, compose E2E, and no-DavDebrid assertion remain |

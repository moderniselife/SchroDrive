...
| C. DavDebrid webhook/snapshot → SchröDrive → Arr | Fork scope; direct API prototype superseded for active integration | [DavDebrid assessment](cinecircle-davdebrid-integration-assessment-2026-09-17.md); [architecture](cinecircle-pipeline-architecture-2026-09-17.md); [E2E plan](cinecircle-three-input-e2e-plan.md) | Webhook consumer, snapshot recovery, changed detection, and compose E2E are not implemented; no production authorization |
